...
} from "../core/middlewares/validation/blogs.validation-middleware/blogs.input.validation-middleware";
...
blogRouter
  ...
  .put('/:id', superAdminGuardMiddleware, idValidation, blogsInputValidation, inputValidationResultMiddleware, updateBlogHandler)

  .post("", superAdminGuardMiddleware, blogsInputValidation, inputValidationResultMiddleware, postBlogHanlder)

  .delete('/:id', superAdminGuardMiddleware, idValidation, inputValidationResultMiddleware, deleteBlogHanlder)
