...
function getCommentByIdHandler(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        const feedBack = yield comments_service_1.commentsService.getCommentById(req.params.id, req.params);
        res.status(http_statuses_1.HTTP_STATUSES.CREATED_201).send(feedBack);
    });
}
