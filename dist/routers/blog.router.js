...
const get_blog_hanlder_1 = require("../blogs/handlers/get-blog.hanlder");
...
exports.blogRouter
    ...
    .get("/:id/posts", id_validation_middleware_1.idValidation, pagination_validation_1.paginationValidation, input_validation_result_middleware_1.inputValidationResultMiddleware, get_post_by_blog_1.getPostByBlogIdHanlder)
    .post("/:id/posts", super_admin_guard_middleware_1.superAdminGuardMiddleware, id_validation_middleware_1.idValidation, post_inputDto_validation_1.postInputDtoValidation, input_validation_result_middleware_1.inputValidationResultMiddleware, create_post_for_blog_handler_1.createPostForBlogHandler);
