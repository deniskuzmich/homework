...
exports.authRouter = (0, express_1.Router)()
    .post('/login', request_log_middleware_1.requestLoggerMiddleware, request_count_middleware_1.requestCountMiddleware, auth_user_handler_1.authUserHandler)
    .post('/refresh-token', refresh_token_handler_1.authRefreshTokenHandler)
    .post('/logout', logout_handler_1.logoutHandler)
    .post('/registration', request_log_middleware_1.requestLoggerMiddleware, request_count_middleware_1.requestCountMiddleware, auth_validation_1.authInputValidation, input_validation_result_middleware_1.inputValidationResultMiddleware, user_registration_handler_1.userRegistrationHandler)
    .post('/registration-confirmation', request_log_middleware_1.requestLoggerMiddleware, request_count_middleware_1.requestCountMiddleware, input_validation_result_middleware_1.inputValidationResultMiddleware, registration_confirm_1.registrationConfirmHandler)
    .post('/registration-email-resending', request_log_middleware_1.requestLoggerMiddleware, request_count_middleware_1.requestCountMiddleware, input_validation_result_middleware_1.inputValidationResultMiddleware, email_resending_1.emailResendingHandler)
