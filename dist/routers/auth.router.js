...
const new_password_validation_1 = require("../auth/middleware/new-password-validation");
exports.authRouter = (0, express_1.Router)()
    ...
    .post('/new-password', request_count_middleware_1.requestCountMiddleware, request_log_middleware_1.requestLoggerMiddleware, new_password_validation_1.newPasswordValidation, input_validation_result_middleware_1.inputValidationResultMiddleware, composition_root_1.newPasswordHandler.newPassword)
